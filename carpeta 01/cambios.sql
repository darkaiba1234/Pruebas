...
cambio 2 pantalla de contrato
despues de cliente
lista de valores de ubicacion
*recaudacion por ubicacion

en detalle de pagos al momento de generar una factura
al generar laa factura 
